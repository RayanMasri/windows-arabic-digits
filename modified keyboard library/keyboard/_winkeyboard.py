...
def get_event_names(scan_code, vk, is_extended, modifiers):
    ...
    #if is_official:
        #print(vk)        
    #if vk >= 176 and vk <= 185:
        #print(f'VK {vk}: ({is_keypad}, {is_official})')
...
def _setup_name_tables():
    ...
    with tables_lock:
        ...
        #ranges = list(range(0x100)) + list(range(0xb0, 0xba))
        ...
        #print(all_scan_codes)
        #print(all_vks)
        #print(list(range(0xb0, 0xba)))
        #print((user32.MapVirtualKeyExW(0xb0, MAPVK_VK_TO_VSC_EX, 0), 0xb0))
